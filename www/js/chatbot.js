    ...
    return {
        Engines: {
            ...
            duckduckgo: function () {
                ...
                let capabilities = [
                    "Mozesz zapytać 'ile punktów ECTS maja podstawy telekomunikacji na kierunku teleinformatyka na pierwszym semestrze'?",
                    "Mozesz zapytać 'ile godzin trwają ćwiczenia z Kierunków rozwoju oprogramowania na kierunku informatyka'?",
                    "Mozesz zapytać o to 'kto prowadzi bazy danych na 4 semetrze na Teleinformatyce'?",
                    "Mozesz zapytać o to 'kto prowadzi bazy danych na 4 semetrze na Teleinformatyce'?",
                    "Zapytaj 'czy jest egazmin z przedmiotu AUE na Elektonice i telkomunikacji'?",
                ];
...
//                                let response = text.replace(r, pattern.actionValue);
        ...
        // ChatBot.addPattern("^hi$", "response", "Howdy, friend", undefined, "Powiedz 'Czesc' aby przywitac sie ze Studenbotem.");
    }
}();